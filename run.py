...
def baner():
    ...
    print(f"""
     ...
     {rgb}╚═╝{W}└─┘ ┴ {rgb} ╚  {W}┴ ┴└─┘└─┘└─┘└─┘└─┘┴ ┴
{ab}-----------------------------------------------
{W}wm   : {rgb}sc  abal abal v jadi jangan di fake 😢
{W}Author  : {rgb}Niki
{W}Follow ig  : {rgb}Nikikiy.4
{W}join wa co  : {rgb}https://wa.me/message/5QC7VVWHBBTSM1
{W}Github   : {rgb}https://github.com/zuc
{W}Facebook : {rgb}https://www.facebook.com/NikigagalTenaa.r8
{ab}-----------------------------------------------""")
